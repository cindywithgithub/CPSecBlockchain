        ...
        <table id="userTable" class="layui-table layui-fluid" lay-size="sm">
            ...
            <tbody>
                <tr>
                    ...
                    <td>  寻找一个nonce值，进行一个Double SHA256运算,
                    使得F（Nonce）< Target
                     算力越大，越容易得到记账权
                    </td>
                </tr>
                <tr>
                    ...
                    <td> F（Timestamp） < Target * Balance , 不单单是算力的比拼，余额越大，越容易得到记账权</td>
                </tr>
                <tr>
                    <td>股份授权证明DPoS（Delegated Proof of Stake）</td>
                    <td>  由股东投票选出101名代表，然后由这些代表负责产生区块, 持币者若想成为代表，需要先用自己的公钥去区块链注册，用户对代表进行投票，选出前101位，轮流获取记账权, 如有恶意代表，则会被踢除，由第102位填补
</td>
                </tr>
